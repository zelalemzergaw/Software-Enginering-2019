...
import edu.mum.cs.cs425.demos.elibrarysearch.elibrarysearch.service.BookService;
...
public class BookController {
    ...
    @RequestMapping("/elibrary/book/list/search")
    public ModelAndView search(@RequestParam String search, @RequestParam(defaultValue = "0") int pageno, Model model){
        Page<Book> books=bookService.search(search,pageno);
        long numberOfStudents= books.getTotalElements();
        ModelAndView modelAndView= new ModelAndView();
